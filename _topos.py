...
class _topo(Topo):
  def build(self):
    ...
    # new hosts
    h40 = self.addHost('h40', mac='00:00:00:00:00:06', ip='10.0.4.20/24', defaultRoute='h40-eth0')
    h50 = self.addHost('h50', mac='00:00:00:00:00:07', ip='10.0.5.30/24', defaultRoute='h50-eth0')
    ...
    self.addLink(s4,cores21)
    self.addLink(s5,cores21)
